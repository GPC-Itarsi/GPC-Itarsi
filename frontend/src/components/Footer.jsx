...
const Footer = () => {
  ...
  return (
    <footer className="relative bg-gradient-to-b from-primary-900 to-secondary-900 text-white shadow-lg">
          ...
          <div className="text-center sm:text-left">
            ...
            <div className="flex justify-center sm:justify-start space-x-5 mt-6">
              {contactInfo?.socialMedia?.facebook && (
                <a href={contactInfo.socialMedia.facebook} target="_blank" rel="noopener noreferrer" className="text-gray-300 hover:text-blue-500 transition-all duration-300 transform hover:scale-110 bg-gray-700 p-2 rounded-full">
              ...
              {contactInfo?.socialMedia?.instagram && (
                <a href={contactInfo.socialMedia.instagram} target="_blank" rel="noopener noreferrer" className="text-gray-300 hover:text-pink-500 transition-all duration-300 transform hover:scale-110 bg-gray-700 p-2 rounded-full">
              ...
              <a href={`mailto:${contactInfo?.email || 'gpc.itarsi@gmail.com'}`} className="text-gray-300 hover:text-red-500 transition-all duration-300 transform hover:scale-110 bg-gray-700 p-2 rounded-full">
          ...
          <div className="text-center md:text-left">
            ...
            <address className="not-italic text-gray-300 space-y-3">
              <div className="flex items-center justify-center md:justify-start">
                <svg className="w-5 h-5 mr-3 text-primary-400 flex-shrink-0" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path fillRule="evenodd" d="M5.05 4.05a7 7 0 119.9 9.9L10 18.9l-4.95-4.95a7 7 0 010-9.9zM10 11a2 2 0 100-4 2 2 0 000 4z" clipRule="evenodd"></path></svg>
                <p>{contactInfo?.address || 'Sankheda Road, Near Canal, Lane 4 Bypass Road, Itarsi, District Narmadapuram'}</p>
              </div>
              <div className="flex items-center justify-center md:justify-start">
                <svg className="w-5 h-5 mr-3 text-primary-400 flex-shrink-0" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path d="M9 6a3 3 0 11-6 0 3 3 0 016 0zM17 6a3 3 0 11-6 0 3 3 0 016 0zM12.93 17c.046-.327.07-.66.07-1a6.97 6.97 0 00-1.5-4.33A5 5 0 0119 16v1h-6.07zM6 11a5 5 0 015 5v1H1v-1a5 5 0 015-5z"></path></svg>
                <p>Madhya Pradesh, India</p>
              </div>
              <div className="flex items-center justify-center md:justify-start">
                <svg className="w-5 h-5 mr-3 text-primary-400 flex-shrink-0" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path d="M2.003 5.884L10 9.882l7.997-3.998A2 2 0 0016 4H4a2 2 0 00-1.997 1.884z"></path><path d="M18 8.118l-8 4-8-4V14a2 2 0 002 2h12a2 2 0 002-2V8.118z"></path></svg>
                <p>Email: <a href={`mailto:${contactInfo?.email || 'gpc.itarsi@gmail.com'}`} className="hover:text-primary-400 transition-colors duration-300">{contactInfo?.email || 'gpc.itarsi@gmail.com'}</a></p>
              </div>
              <div className="flex items-center justify-center md:justify-start">
                <svg className="w-5 h-5 mr-3 text-primary-400 flex-shrink-0" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path d="M2 3a1 1 0 011-1h2.153a1 1 0 01.986.836l.74 4.435a1 1 0 01-.54 1.06l-1.548.773a11.037 11.037 0 006.105 6.105l.774-1.548a1 1 0 011.059-.54l4.435.74a1 1 0 01.836.986V17a1 1 0 01-1 1h-2C7.82 18 2 12.18 2 5V3z"></path></svg>
                <p>Phone: <a href={`tel:${contactInfo?.phone || '+918964035180'}`} className="hover:text-primary-400 transition-colors duration-300">{contactInfo?.phone || '+91 8964035180'}</a></p>
              </div>
              {contactInfo?.officeHours && (
                <div className="flex items-center justify-center md:justify-start">
                  <svg className="w-5 h-5 mr-3 text-primary-400 flex-shrink-0" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path fillRule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm1-12a1 1 0 10-2 0v4a1 1 0 00.293.707l2.828 2.829a1 1 0 101.415-1.415L11 9.586V6z" clipRule="evenodd"></path></svg>
        ...
        <div className="mt-10 pt-8 border-t border-gray-700 text-center">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <div className="text-gray-400 mb-4 md:mb-0">
              <p>&copy; {currentYear} <span className="text-primary-400 font-medium">Government Polytechnic College, Itarsi</span>. All rights reserved.</p>
              <div className="mt-4 inline-block">
                <button
                  onClick={() => setShowDeveloperCard(true)}
                  className="py-2 px-4 bg-gradient-to-r from-primary-800 to-primary-900 rounded shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1 hover:scale-105 focus:outline-none focus:ring-2 focus:ring-primary-400 focus:ring-opacity-50 group flex items-center space-x-2 relative overflow-hidden border border-primary-700/50"
                >
                  ...
                  <div className="absolute inset-0 bg-gradient-to-r from-transparent via-accent-500/20 to-transparent w-[200%] h-full -translate-x-full group-hover:translate-x-[75%] transition-transform duration-1000 ease-in-out"></div>
