          ...
          <div className="text-center sm:text-left">
            ...
            <div className="flex justify-center sm:justify-start space-x-5 mt-6" ref={socialIconsRef}>
              {contactInfo?.socialMedia?.facebook && (
                <a href={contactInfo.socialMedia.facebook} target="_blank" rel="noopener noreferrer" className="footer-social-icon text-blue-400 p-2 rounded-full">
              ...
              {contactInfo?.socialMedia?.instagram && (
                <a href={contactInfo.socialMedia.instagram} target="_blank" rel="noopener noreferrer" className="footer-social-icon text-pink-400 p-2 rounded-full">
              ...
              <a href={`mailto:${contactInfo?.email || 'gpc.itarsi@gmail.com'}`} className="footer-social-icon text-cyan-400 p-2 rounded-full email-icon">
