            ...
            <div className="flex justify-center space-x-4 mb-6 px-8 w-full">
              ...
              {developer.socialLinks?.linkedin && (
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="bg-blue-600 p-2 rounded-full hover:bg-blue-500 transition-all duration-300 transform hover:scale-110"
                  aria-label="LinkedIn"
                >
                  <svg className="w-5 h-5 text-white" fill="currentColor" viewBox="0 0 24 24">
              ...
              {developer.socialLinks?.instagram && (
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="bg-pink-600 p-2 rounded-full hover:bg-pink-500 transition-all duration-300 transform hover:scale-110"
              ...
              {developer.socialLinks?.twitter && (
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="bg-blue-400 p-2 rounded-full hover:bg-blue-300 transition-all duration-300 transform hover:scale-110"
                  aria-label="Twitter"
                >
                  <svg className="w-5 h-5 text-white" fill="currentColor" viewBox="0 0 24 24">
              ...
              {developer.socialLinks?.portfolio && (
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="bg-purple-600 p-2 rounded-full hover:bg-purple-500 transition-all duration-300 transform hover:scale-110"
