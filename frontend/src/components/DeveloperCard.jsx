...
const DeveloperCard = ({ isOpen, onClose, developerData }) => {
    ...
    return (
      <div className="fixed inset-0 z-50 overflow-y-auto bg-black bg-opacity-60 backdrop-blur-sm flex items-center justify-center p-4">
        <div className="bg-white p-6 rounded-lg shadow-xl">
          ...
          <button
            onClick={onClose}
            className="mt-4 w-full bg-accent-500 text-white py-2 px-4 rounded hover:bg-accent-600 transition-colors"
          >
            Close
          </button>
        </div>
  ...
  return (
    <div className="fixed inset-0 z-50 overflow-y-auto bg-black bg-opacity-80 backdrop-blur-sm flex items-center justify-center p-4">
      <div
        ref={modalRef}
        className="relative max-w-md w-full mx-auto overflow-hidden animate-fadeIn"
      >
        <div className="bg-gradient-to-br from-primary-800 to-primary-900 text-white rounded-xl shadow-2xl overflow-hidden border border-primary-700/50">
          ...
          <button
            onClick={onClose}
            className="absolute top-3 right-3 text-white/80 hover:text-white p-2 rounded-full hover:bg-accent-600/50 transition-all duration-200 z-10 focus:outline-none focus:ring-2 focus:ring-accent-400"
            aria-label="Close"
          >
          ...
          <div className="relative pt-8 pb-6 px-6 text-center">
            ...
            <div className="absolute top-0 left-0 w-full h-1.5 bg-gradient-to-r from-accent-400 via-accent-500 to-accent-400"></div>

            {/* Profile image */}
            <div className="relative inline-block mb-4">
              <div className="w-28 h-28 rounded-full border-3 border-accent-400 overflow-hidden shadow-lg mx-auto p-1 bg-primary-900/50">
                <img
              ...
              {/* Tech badge */}
              <div className="absolute -bottom-1 -right-1 w-9 h-9 rounded-md bg-accent-600 flex items-center justify-center text-white text-xs font-bold shadow-lg border border-accent-400">
            ...
            <p className="text-accent-300 text-md font-medium">{developer.title}</p>
          </div>

          {/* Content area */}
          <div className="bg-gradient-to-b from-primary-900/80 to-secondary-900/90 px-6 pt-5 pb-6 border-t border-primary-700/30">
            {/* Bio section with tech-inspired design */}
            <div className="bg-primary-800/30 p-4 rounded-lg border border-primary-700/30 mb-6">
              <p className="text-primary-100 text-sm leading-relaxed">
                {developer.bio?.length > 100 ? `${developer.bio.substring(0, 100)}...` : developer.bio}
              </p>
            </div>

            {/* Social media links - Redesigned as larger buttons */}
            <div className="grid grid-cols-3 gap-3 mb-6">
              {developer.socialLinks?.github && (
                <a
                  ...
                  className="flex flex-col items-center p-3 rounded-lg bg-gray-800 hover:bg-gray-700 transition-all duration-300 transform hover:scale-105 shadow-md"
                  aria-label="GitHub"
                >
              ...
              {developer.socialLinks?.linkedin && (
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="flex flex-col items-center p-3 rounded-lg bg-blue-700 hover:bg-blue-600 transition-all duration-300 transform hover:scale-105 shadow-md"
                  aria-label="LinkedIn"
                >
                  <svg className="w-6 h-6 text-white mb-1" fill="currentColor" viewBox="0 0 24 24">
              ...
              {developer.socialLinks?.instagram && (
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="flex flex-col items-center p-3 rounded-lg bg-pink-600 hover:bg-pink-500 transition-all duration-300 transform hover:scale-105 shadow-md"
              ...
              {developer.socialLinks?.twitter && (
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="flex flex-col items-center p-3 rounded-lg bg-blue-500 hover:bg-blue-400 transition-all duration-300 transform hover:scale-105 shadow-md"
                  aria-label="Twitter"
                >
                  <svg className="w-6 h-6 text-white mb-1" fill="currentColor" viewBox="0 0 24 24">
              ...
              {developer.socialLinks?.portfolio && (
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="flex flex-col items-center p-3 rounded-lg bg-purple-600 hover:bg-purple-500 transition-all duration-300 transform hover:scale-105 shadow-md"
              ...
              {developer.socialLinks?.email && (
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="flex flex-col items-center p-3 rounded-lg bg-red-600 hover:bg-red-500 transition-all duration-300 transform hover:scale-105 shadow-md"
                  aria-label="Email"
                >
                  <svg className="w-6 h-6 text-white mb-1" fill="currentColor" viewBox="0 0 24 24">
            ...
            <div className="text-center">
              <a
                ...
                className="inline-block px-8 py-3 bg-gradient-to-r from-accent-600 to-accent-500 rounded-md text-white font-medium shadow-md hover:shadow-lg transition-all duration-300 transform hover:scale-105 border border-accent-400/30 relative overflow-hidden group"
              >
                {/* Animated tech effect */}
                <div className="absolute inset-0 bg-gradient-to-r from-transparent via-white/20 to-transparent w-[200%] h-full -translate-x-full group-hover:translate-x-[75%] transition-transform duration-1000 ease-in-out"></div>
