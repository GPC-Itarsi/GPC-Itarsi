...
const DeveloperCard = ({ isOpen, onClose, developerData }) => {
  ...
  return (
    <div className="fixed inset-0 z-50 overflow-y-auto bg-black bg-opacity-80 backdrop-blur-sm flex items-center justify-center p-4">
      ...
      >
        <div className="bg-gradient-to-br from-primary-800 to-primary-900 text-white rounded-lg shadow-2xl overflow-hidden border border-primary-700/50">
          ...
          {/* Content area */}
          <div className="bg-gradient-to-b from-primary-900/80 to-secondary-900/90 px-5 pt-4 pb-5 border-t border-primary-700/30">
            ...
            <div className="text-center">
              <a
                ...
                className="inline-block px-6 py-2.5 bg-gradient-to-r from-accent-600 to-accent-500 rounded-md text-white text-sm font-medium shadow-md hover:shadow-lg transition-all duration-300 transform hover:scale-105 border border-accent-400/30 relative overflow-hidden group"
              >
