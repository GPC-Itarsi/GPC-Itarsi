                      ...
                      <div className="mt-4 space-y-4">
                        ...
                        <div>
                          ...
                          <div className="mt-1 text-xs text-gray-500 space-y-1">
                            <p>You can add clickable links using HTML:</p>
                            <p><code>&lt;a href="https://example.com"&gt;Link text&lt;/a&gt;</code></p>
                            <p className="text-primary-600">Links will be automatically opened in a new tab when clicked.</p>
                            <div className="flex items-center mt-2">
                              <button
                                type="button"
                                className="text-primary-600 hover:text-primary-800 text-sm font-medium focus:outline-none flex items-center"
